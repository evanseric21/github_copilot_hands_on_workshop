...
- If those entry points are unavailable, ask Copilot Chat to review selected C# code for correctness, edge cases, and tests.
...
Expected first five lines are in [Lab 5 contract](../labs/05-build-analyzer/contract.md#6-pinned-expected-output).
